...
- Support JCasC #404 [JENKINS-53641](https://issues.jenkins-ci.org/browse/JENKINS-53641)
  - [example](/README.md#configuration-as-code)
- Add Token Macro support #401
...
- Reduce verbosity for standard case when the migrator does nothing #395
- Updated docs - Added multiple channel comment to slackSend #399
- Create Jenkinsfile #405

## Security Related:

- jackson-databind -> 2.8.11.2, security fix #400
